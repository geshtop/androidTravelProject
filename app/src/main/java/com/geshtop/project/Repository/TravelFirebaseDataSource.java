...
public  class TravelFirebaseDataSource implements ITravelDataSource {
    ...
    private List<com.geshtop.project.Entity.Travel> allTravelsList;

    private ITravelDataSource.NotifyToTravelListListener notifyToTravelListListener;

    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    DatabaseReference travels = firebaseDatabase.getReference("TraveRequest");
    ...
    public void addTravel(Travel p) {
        String id = p.getTravelId();
        if(id == null || id.isEmpty()) {
            id = travels.push().getKey();
            p.setTravelId(id);
        }
